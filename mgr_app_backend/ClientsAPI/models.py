...
class Clients(models.Model):
	...
	student_phone = models.CharField(max_length=200, blank=True, validators=[validatePhoneField])
	...
	invoice_phone = models.CharField(max_length=100, blank=True, validators=[validatePhoneField])
